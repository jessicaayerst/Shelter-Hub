...
{
    public partial class BuildTables1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepTypeName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OkToText = table.Column<bool>(nullable: false),
                    EmergencyPhone = table.Column<string>(nullable: true),
                    EmergencyName = table.Column<string>(nullable: true),
                    AssignedStaff = table.Column<string>(nullable: true),
                    RoomNumber = table.Column<int>(nullable: false),
                    IntakeComplete = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientSteps_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientSteps_Steps_StepId",
                        column: x => x.StepId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientSteps_ClientId",
                table: "ClientSteps",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientSteps_StepId",
                table: "ClientSteps",
                column: "StepId");
